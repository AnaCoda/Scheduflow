...
<body>
    ...
    <div id="wrap">
        ...
        <div style="width:500px" class="text-center">
            <input type="text" name="uname" placeholder="Username" class="" /><br>
            <input type="text" name="email" placeholder="Email" class="" /><br>
            <input type="password" name="pass" placeholder="Password" class="" /><br>
            <input type="password" name="pass2" placeholder="Confirm Password" class="" /><br>
